...
public class FrameAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblTaiLieuMuon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã mượn", "Tên bạn đọc", "Tên tài liệu", "Tên thủ thư", "Số lượng", "Ngày mượn", "Ngày trả"
            }
        ));
         ...
         try {
            ...
            if (i == 0) {
                if (taiLieuMuonBLL.datLaiMatKhau(taiLieuMuon)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Xem lại tài mã mượn, mã tài liệu, mã thủ thư, mã bạn đọc");
                    JOptionPane.showMessageDialog(null, "Đặt lại không thành công");
                }
            }
        } catch (HeadlessException e) {
